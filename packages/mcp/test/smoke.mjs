...
assert.ok(TOOL_NAMES.includes("auth_status"), "auth_status missing");
assert.ok(TOOL_NAMES.includes("admin_logout"), "admin_logout missing");
assert.ok(TOOL_NAMES.includes("set_project_session"), "set_project_session missing");
assert.ok(TOOL_NAMES.includes("create_host"), "create_host missing");
assert.ok(TOOL_NAMES.includes("list_hosts"), "list_hosts missing");
assert.ok(TOOL_NAMES.includes("get_host"), "get_host missing");
