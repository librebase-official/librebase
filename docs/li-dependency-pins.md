...
| lidb | `C:\Users\Julian\Documents\Programming\li\lidb` | `feat/wave-3-migrate-depth` @ `e9abac6` | Wave 3 UNIQUE/multi-col INDEX + POLICY metadata (MR !4). Includes W2 changefeed + W1 RLS |
| lis | `C:\Users\Julian\Documents\Programming\li\lis` | `feat/wave-4-lis-rest` @ `08ecd3e` | Wave 4 lis-rest .li + lic gate + LI_REST_REQUIRE_LI (MR !153). Python `/rest/v1` MVP until lic P0 httpd |
