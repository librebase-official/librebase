...
| T6 | `.github/workflows/parity.yml` | T5 | AC-3.1–3.3 | deferred — runner + docs; workflow file needs GitHub `workflow` scope to push |
...
| T16 | Commit/push Librebase + lis + lidb | T15 | remotes updated | in progress |
