...
**Human gates:** SDD accepted 2026-07-30. MVP tasks complete.  
**Deferred:** CREATE TABLE DDL exec; engine RLS; Studio IO UI; pg_dump custom; lit/native Li; hard P-IO-01 / P-RT-01.
