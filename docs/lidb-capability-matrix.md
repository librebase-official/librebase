...
| 6 | Object Storage | Storage | **lis** `routes/storage` + `packages/lis-storage` | ✅ | Bucket CRUD + HMAC signed GET + **SigV4-shaped** query MVP (`signV4:true`). Multipart, `public_read`. Not full AWS SigV4 / TUS / CDN |
